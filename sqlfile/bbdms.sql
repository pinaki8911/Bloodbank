...
(1, 'A-', '2019-02-30 20:33:50'),
(2, 'AB-', '2019-02-30 20:34:00'),
(3, 'O-', '2019-02-30 20:34:05'),
(4, 'A-', '2019-02-30 20:34:10'),
(5, 'A+', '2019-02-30 20:34:13'),
(6, 'AB+', '2019-02-30 20:34:18'),
(7, 'B+', '2019-02-30 20:34:13'),
(8, 'B-', '2019-02-30 20:34:13'),
(9, 'O+', '2019-02-30 20:34:13'),;
...
CREATE TABLE IF NOT EXISTS `donage` (
  `id` int(11) NOT NULL,
  `age` int(11)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

INSERT INTO `donage`(`id`, `age`) VALUES('1','18'),('2','19'),('3','20'),('4','21'),('5','22'),('6','23'),('7','24'),('8','25'),('9','26'),('10','27'),('11','28'),('12','29'),('13','30'),('14','31'),('15','32'),('16','33'),('17','34'),('18','35'),('19','36'),('20','37'),('21','38'),('22','39'),('23','40'),('24','41'),('25','42'),('26','43'),('27','44'),('28','45'),('29','46'),('30','47'),('31','48'),('32','49'),('33','50'),('34','51'),('35','52'),('36','53'),('37','54'),('38','55'),('39','56'),('40','57'),('41','58'),('42','59'),('43','60'),('44','61'),('45','62'),('46','63'),('47','64'),('48','65'),('49','66'),('50','67'),('51','68'),('52','69'),('53','70');
